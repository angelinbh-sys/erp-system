...
const AgendamentoASO = () => {
  ...
  const handleDevolver = async () => {
    ...
    try {
      ...
      await supabase.from("notificacoes").insert({ titulo: "Vaga devolvida pelo SESMT", mensagem: `A vaga ${devolverVaga.cargo} (${devolverVaga.nome_candidato}) foi devolvida pelo SESMT. Motivo: ${motivoDevolucao.trim()}`, tipo: "warning", link: "/rh/aprovacao-vagas", vaga_id: devolverVaga.id });
